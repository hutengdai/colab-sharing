...
def generate_testing(file_path, output_path, tokcount_path):

	with open(file_path, "r", encoding="utf-8") as csv_file:
		reader = csv.DictReader(csv_file)
		with open(output_path, "w", encoding="utf-8") as new_file:
			with open(tokcount_path, "w", encoding="utf-8", newline='') as csv_out:
...
if __name__ == "__main__":
	...
	output_path = "data/polish/TestingData.txt"
	...
	generate_testing(file_path, output_path, tokcount_path)
